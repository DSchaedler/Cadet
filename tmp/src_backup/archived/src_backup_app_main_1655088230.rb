...
class Game
  def tick(args)
    ...
    args.outputs.sprites << {x: 0, y: @cabinet.y - @ball.y + args.grid.center_y - @ball.h , w: @cabinet.w, h: 720, path: :table, source_y: @cabinet.y - @ball.y + args.grid.center_y - @ball.h}
  end
